 ...
 * @author Vivek Pandey
 */
public final class SOAP11Constants {
    ...
    public static final QName SOAPADDRESS_NAME = new QName(SOAP_NS, "address");
    public static final QName SOAPBODY_NAME = new QName(SOAP_NS, "body");
    public static final QName SOAPFAULT_NAME = new QName(SOAP_NS, "fault");
