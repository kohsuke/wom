...
public enum SOAPVersion {
    SOAP11(SOAP11Constants.SOAP_NS), SOAP12(SOAP12Constants.SOAP_NS);

    private SOAPVersion(String ns){
        this.namespace = ns;
    }

    /**
     * Gives the SOAPVersion for the given namespace.
     * @param ns always non-null
     * @return null if the namespace is not from SOAP11 or SOAP 12 namespace
     */
