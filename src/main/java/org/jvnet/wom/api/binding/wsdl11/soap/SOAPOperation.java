...
public interface SOAPOperation extends WSDLExtension {
    ...
    /**
     * The default value is false. It can be true only for SOAP 1.2 binding
     * for WSDL 1.1. When true it tells that the server required the SOAPAction value
     * to be present as HTTP header.
     */
